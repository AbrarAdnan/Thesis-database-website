			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php"  >
						<img src="images/bauet.png" alt="" height="50px" width="50px"> ICE</a>
				</div>
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
								<a class="nav-link" href="https://corona.gov.bd/">Covid 19 info</a>
							</li>
                            <li class="nav-item">
								<a class="nav-link" href="https://bauet.ac.bd/">BAUET</a>
							</li>
                            <li class="nav-item">
								<a class="nav-link" href="https://bauet.ac.bd/ice/">Department of ICE</a>
							</li>
